...
<div class="container-fluid mb-4">
    <div class="container">
        <div class="col-12 text-center contact_margin_svnit ">
            <div class="text-center fh5co_heading py-2"> قم بتحميل الفيديو </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-6">
                <form class="row" id="fh5co_contact_form"  action="UploadImage" enctype = "multipart/form-data" method="post">
                    ...
                    <div class="col-12 py-3">
                    <input type="text" name="type"  class="form-control fh5co_contact_text_box" value="<%=Video.VIDEO%>" readonly />
                    </div>
