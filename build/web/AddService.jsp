...
//        check for logi
       ...
       String project_id=request.getParameter(Service.PROJCET_ID);
        ...
        String service_type=request.getParameter(Service.SERVICE_TYPE);
        if(service_type!=null && project_id!=null){
            Service s=new Service(0, Integer.parseInt(project_id), service_type);
            Services.add(s);
...
<div class="container-fluid mb-4">
    <div class="container">
        <div class="col-12 text-center contact_margin_svnit ">
            <div class="text-center fh5co_heading py-2">اضف معلومات الخدمة </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-6">
                <form class="row" id="fh5co_contact_form"  action=""   method="post">
                    ...
                    <div class="col-12 py-3">
                         <textarea name="service_type" class="form-control fh5co_contacts_message" placeholder="Project service here..." required ></textarea>
                    </div>
