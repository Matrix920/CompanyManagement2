...
//        check for logi
        ...
        int id=Integer.parseInt(project_id);
         List<Property>properties=Properties.get_all_properties(id);
         List<Service>services=Services.get_project_services(id);
         List<Picture>pictures=Pictures.get_all(id);
         List<Video>videos=Videos.get_all(id);
...
<table id="customers">
  ...
  <div class="container-fluid pt-3">
    <div class="container animate-box" data-animate-effect="fadeIn">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">الخدمات المتاحة</div>
        </div>
        <div>
<table id="customers">
  <tr>
        ...
        <div class="owl-carousel owl-theme" id="slider2">
            ...
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img src="<%=p.picture_path%>" alt=""/></div>
