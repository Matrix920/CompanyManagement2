...
List<Inquiry> inquiries=Inquiries.get_all_questions();
...
<div class="container-fluid pt-3">
    <div class="container animate-box" data-animate-effect="fadeIn">
        <div>
            <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">استفسارات الزبائن</div>
        </div>
        <div>
<table id="customers">
  <tr>
  ...
  <tr>
      ...
      <td>
          <%= Users.get(q.user_id).username %>
      </td>
   
      <td>
          <a  class="btn btn-info"  href="AnswerInquiry.jsp?inquiry_id=<%=q.inquiry_id %>">الإجابة عن الاستفسار</a>
      </td>
