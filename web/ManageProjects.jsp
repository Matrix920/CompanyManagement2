...
<table id="customers">
  ...
  <tr>
      ...
      <td>
          <a  class="btn btn-info"  href="AddPicture.jsp?project_id=<%=p.project_id%>">إضافة صور</a>
          <a  class="btn btn-info"   href="AddVideo.jsp?project_id=<%=p.project_id%>">إضافة فيديو</a>
          <a   class="btn btn-info"  href="AddService.jsp?project_id=<%=p.project_id%>">إضافة خدمات</a>
          <a   class="btn btn-info"  href="AddProperty.jsp?project_id=<%=p.project_id%>">إضافة عقار</a>
      </td>
