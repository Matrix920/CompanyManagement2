...
//        check for logi
      ...
      String inquiry_id=request.getParameter(Inquiry.INQUIRY_ID);
        if(inquiry_id==null)
            response.sendRedirect("ManageInquiries.jsp");
        
        String answer_title=request.getParameter(Inquiry.ANSWER_TITLE);
        if(answer_title!=null && inquiry_id!=null){
            Inquiry q=new Inquiry(Integer.parseInt(inquiry_id),"",  answer_title, true, 0);
           Inquiries.update(q);
...
<div class="container-fluid mb-4">
    <div class="container">
        <div class="col-12 text-center contact_margin_svnit ">
            <div class="text-center fh5co_heading py-2">الإجابة عن الاستفسار</div>
            <div class="text-center fh5co_heading py-2"> <%=Inquiries.get(Integer.parseInt(inquiry_id)).inquiry_title%> </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-6">
                <form class="row" id="fh5co_contact_form" action="" method="post">
                     <div class="col-12 py-3">
                         <textarea name="answer_title" class="form-control fh5co_contacts_message" placeholder="your answer here..." required ></textarea>
                    </div>
